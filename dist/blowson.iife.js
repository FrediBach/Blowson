(function (_, traverse, Chance, slugify, md5, dateFns, numeral, marked, Prob, pluralize, v, RandExp, faker, is) {
  'use strict';
...
}(_, traverse, Chance, slugify, md5, dateFns, numeral, marked, Prob, pluralize, v, RandExp, faker, is));
