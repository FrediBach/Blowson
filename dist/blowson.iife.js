(function (_, Chance, faker, stringify, slugify, md5, dateFns, numeral, marked, Prob, pluralize, v, RandExp) {
  'use strict';
...
}(_, Chance, faker, stringify, slugify, md5, dateFns, numeral, marked, Prob, pluralize, v, RandExp));
