define(['lodash', 'traverse', 'chance', 'slugify', 'md5', 'date-fns', 'numeral', 'marked', 'prob.js', 'pluralize', 'voca', 'randexp', 'faker', 'is_js'], function (_, traverse, Chance, slugify, md5, dateFns, numeral, marked, Prob, pluralize, v, RandExp, faker, is) { 'use strict';
