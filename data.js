module.exports = {
    users: [
        { id: 1, name: 'Fredi Bach', country: 'CH', birthday: '1975-09-03', sex: 'm', email: 'osxcode@gmail.com', userStatus_id: 2, registered: '2018-06-22T09:02:11+01:00', file_id: 1 },
        { id: 2, name: 'Samuel Patzen', country: 'CH', birthday: '1978-02-01', sex: 'm', email: 'patzen@bluewin.ch', userStatus_id: 2, registered: '2018-07-01T09:05:11+01:00' },
        { id: 30, name: 'Hans Muster', country: 'CH', birthday: '1983-02-01', sex: 'm', email: 'hans.muster@domain.ch', userStatus_id: 1, registered: '2018-04-01T09:04:11+01:00' }
    ],
    userStatuses: [
        { id: 1, key: 'inactive' },
        { id: 2, key: 'active' },
    ...
    leagues: [
        ...
        { id: 2, name: 'Austria', yearly: true, description: 'Waypoint are all placed in Austria by local instructors and top pilots.', created: '2018-05-02T12:00:00+01:00', seasonStart: '10-01', seasonEnd: '09-31', file_id: 2 },
        { id: 3, name: 'Vol Liber Grischun Clubmeisterschaft', yearly: false, created: '2018-05-02T12:00:00+01:00', seasonStart: '2018-10-01', seasonEnd: '2048-10-01' }
    ],
    userLeagues: [
    ...
    waypointChats: [
        ...
        { id: 2, waypoint_id: 1, user_id: 2, message: 'Oh yes, it can!', datetime: '2018-07-02T12:23:05+01:00' }
    ],
    wings: [
    ...
    flights: [
        ...
        { id: 2, user_id: 2, league_id: 1, wing_id: 2, date: '2018-07-03T12:00:00+01:00', score: 100, file_id: 5 }
    ],
    favoriteFlights: [
        { id: 1, user_id: 1, flight_id: 2, datetime: '2018-07-02T12:00:00+01:00' }
    ],
    flightWaypoints: [
        { id: 1, flight_id: 1, waypoint_id: 1, datetime: '2018-07-02T12:48:45+01:00', score: 100 },
        { id: 2, flight_id: 1, waypoint_id: 2, datetime: '2018-07-02T13:11:59+01:00', score: 100 },
        { id: 3, flight_id: 2, waypoint_id: 2, datetime: '2018-08-02T14:06:11+01:00', score: 100 }
    ],
    flightComments: [
        { id: 1, flight_id: 1, user_id: 2, datetime: '2018-08-02T14:06:11+01:00', text: 'Ok, that was nice!' },
        { id: 2, flight_id: 1, user_id: 1, datetime: '2018-08-02T14:09:11+01:00', text: 'Thanks' }
    ],
